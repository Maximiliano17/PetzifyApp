         ...
         <div className={styles.containerProfileView}> 
            <section className={styles.profileCard}>
             <div className={styles.bannerProfile}>
              <img className={styles.imageProfile} src={noUserFound} alt="Imagen De Perfil"/>
             </div>
            ...
            <section className={styles.petCardRes}>
             <img className={styles.imagePetProfile} src={noPetFound} alt="Imagen De No Perfil De Mascota"/>
            </section>
